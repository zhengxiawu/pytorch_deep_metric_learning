...
if __name__ == '__main__':
    ...
    #model_path = '/home/zhengxiawu/project/pytorch_deep_metric_learning/checkpoints/mxnet_resnet_50_cub_s_1/0_model.pth'
    #model_path = '/home/zhengxiawu/project/pytorch_deep_metric_learning/checkpoints/mxnet_resnet_50_cub_s_1/100_model.pth'
    model_path = '/home/zhengxiawu/project/pytorch_deep_metric_learning/checkpoints/mxnet_resnet_50_cub_s_1_dim_0/0_model.pth'
    load_num_round = 0
    data = 'cub'
